...
- **ledger:** Initial core. `TrackPath`, `TrackConfig`, `GroupRef{Epoch, Sequence}`, and `GroupMeta` carrying two independent time ranges — media time in the track's timescale for exact intra-track seeking, wallclock in Unix nanoseconds for cross-track correlation. Neither alone is sufficient: media time is skew-free but relative to one track's origin, wallclock is absolute but drifts.
